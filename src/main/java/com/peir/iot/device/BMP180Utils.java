...
public class BMP180Utils {
    ...
    /**
     * Returns the pressure at sea-level given the known altitude and measured
     * pressure.
     * 
     * Given a reference altitude (m) and measured pressure (hPa) at that
     * altitude, calculates the pressure at sea level (hPa) using the
